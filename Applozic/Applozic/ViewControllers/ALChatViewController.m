...
-(void)getUserInformation
{
    ...
    if (viewID)
    {
        storyboard = [UIStoryboard storyboardWithName:[ALApplozicSettings getClientStoryBoard] bundle:nil];
        ALReceiverProfile * userProfileVC = [storyboard instantiateViewControllerWithIdentifier:viewID];
        userProfileVC.alContact = self.alContact;
        //[self presentViewController:userProfileVC animated:YES completion:nil];
        [self.navigationController pushViewController:userProfileVC animated:YES];
    }
    else
    {
        storyboard = [UIStoryboard storyboardWithName:@"Applozic"
                                               bundle:[NSBundle bundleForClass:[self class]]];
        
        ALReceiverUserProfileVC * userProfileVC = (ALReceiverUserProfileVC *)[storyboard instantiateViewControllerWithIdentifier:@"ALReceiverUserProfile"];
        userProfileVC.alContact = self.alContact;
        [self.navigationController pushViewController:userProfileVC animated:YES];
    }
