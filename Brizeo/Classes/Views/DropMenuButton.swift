...
class DropMenuButton: UIButton, UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let itemLabel = UILabel(frame: CGRect(x: 0, y: 0, width: self.frame.width, height: self.frame.height + 1))
        ...
        itemLabel.layer.cornerRadius = 0
        itemLabel.layer.borderWidth = 1
        itemLabel.layer.borderColor = UIColor.gray.cgColor
        ...
        cell.separatorInset = UIEdgeInsetsMake(1, self.frame.width, 0, self.frame.width)
