...
class UserProvider: NSObject {
    ...
    struct FacebookConstants {
        ...
        static let eventParameters = ["fields" : "events.limit(300){name,description,cover,is_canceled,attending_count,rsvp_status,start_time,place,id,attending.limit(10000000){id}}"]
