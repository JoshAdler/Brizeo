...
enum LocalizableString: String {
    ...
    case TimerBottomText = "Please continue to enjoy other functions on Brizeo.  Post a new picture to the Moments wall so members see you first!"
    case MomentsMustHave = "Moments \n Must Have a Description!"
    case TimerTopText = "until you can connect with more members"
    case Later = "Later"
    case LocationDisabled = "You didn't enable location services for Brizeo. Please allow location for a better user experience."
    ...
    case ShareDefaultText = "%@ invites you to join Brizeo!\n\nWhether you're at home or abroad, Brizeo provides a way to meet new people and broaden your inner circle. Connect through your favorite Moments, primary Passions, and live Events. Check it out at %@"
    case BrizeoShareWithFacebook = "Connect at home and abroad."
    case BrizeoShareDescription = "Whether you're at home or abroad, Brizeo provides a way to meet new people and broaden your inner circle. Connect through your favorite Moments, primary Passions, and live Events."
    ...
    case SelectInterest = "Select an Interest for this Moment"
    ...
    case SelectInterests = "Select your interest categories:"
