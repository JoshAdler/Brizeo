...
//  KGBase
//
//  Created by Ernesto Carrion on 1/13/15.
//  Copyright (c) 2015 Kogi Mobile. All rights reserved.
//

#import "NSDate+Kogi.h"

@interface KGDateFormatter : NSDateFormatter
@end
...
@implementation NSDate (Kogi)


static KGDateFormatter *_dateFormatter = nil;

#pragma mark - Date formatter access
+(KGDateFormatter*)sharedDateFormatter
{
    ...
    @synchronized(self)
    {
        if(_dateFormatter == nil)
            _dateFormatter = [[KGDateFormatter alloc] init];
        
        //Here we should put the object in KGCache
...
{
    return [[self differenceInUnit:NSCalendarUnitWeekOfYear sinceDate:inDate] weekOfYear];
}
...
#pragma mark - Get naxt and later dates
- (NSDate *)nextDay
{
...
- (NSInteger)dateComponentHash
{
    ...
    return tmpCurrentDay * tmpCurrentYear * tmpCurrentMonth;
}
