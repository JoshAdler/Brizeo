...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CLLocationManager-blocks/CLLocationManager_blocks.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/InstagramImagePicker/InstagramImagePicker.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MSRangeSlider/MSRangeSlider.framework"
